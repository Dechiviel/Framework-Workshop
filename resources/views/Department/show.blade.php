    ...
    <div class="relative flex items-center justify-center">
        <div class="w-full max-w-3xl bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="bg-blue-800 px-6 py-4">
                <h2 class="text-lg font-semibold text-white">Detail Data Departemen</h2>
            </div>
            ...
            <table class="min-w-full text-sm text-gray-700">
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        <th class="w-1/3 px-6 py-3 text-left font-medium bg-gray-50">Nama Departemen</th>
                        <td class="px-6 py-3">{{ $data['department'] }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3">
                            ...
                            @else
                                <p class="text-gray-500 italic">Belum ada pegawai di departemen ini.</p>
                            @endif
                        </td>
                    </tr>
                </tbody>
