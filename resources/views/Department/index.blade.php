...
@section('content')
    ...
    <div class="relative flex items-center mb-6 mt-3">
        ...
        <div class="ml-auto me-4">
            <a href="{{ route('department.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-700 to-purple-700 
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="text-sm font-medium text-gray-900">{{ $department->nama_departemen }}
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $totalEmployeeOnDepartment[$department->id] ?? 0 }}</div>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Start by adding your first department</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
