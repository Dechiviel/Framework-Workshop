...
@section('content')
    ...
    <div class="relative flex items-center justify-center mx-20">
        <div class="shadow-lg rounded-3xl w-full bg-white p-10">
            <form action="{{ route('position.store') }}" method="post" class="w-full">
                @csrf


                <div class="flex flex-col justify-start">
                    <h1 class="text-3xl font-bold text-gray-700 mb-6 mt-2">Form Jabatan</h1>
                </div>
                ...
                <div>
                    ...
                    <div class="relative input-container">
                        {{-- input tampilan (ada format ribuan) --}}
