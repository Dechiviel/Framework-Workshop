    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md transform transition-all scale-95 opacity-0 modal-content">
        ...
        <div class="px-6 pt-6 pb-4 border-b border-gray-100">
            <div class="flex items-center justify-between">
                ...
                <button type="button" id="closeModalX" class="text-gray-400 hover:text-gray-600 transition-colors">
        ...
        <div class="p-6 space-y-3 max-h-[400px] overflow-y-auto">
            <button type="button" data-value="aktif"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-full bg-green-100 group-hover:bg-green-500 flex items-center justify-center transition-colors duration-300">
                        ...
                        <div>
                            <span class="font-semibold text-gray-800 group-hover:text-green-700 transition-colors duration-300">Aktif</span>
                            <p class="text-xs text-gray-500 group-hover:text-green-600">Status sedang berjalan</p>
                        </div>
                    </div>
            ...
            <button type="button" data-value="nonaktif"
                class="status-option group w-full text-left px-5 py-4 rounded-2xl border-2 border-gray-200 hover:border-red-500 hover:bg-red-50 transition-all duration-300 transform hover:shadow-md">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 rounded-full bg-red-100 group-hover:bg-red-500 flex items-center justify-center transition-colors duration-300">
                        ...
                        <div>
                            <span class="font-semibold text-gray-800 group-hover:text-red-700 transition-colors duration-300">Nonaktif</span>
                            <p class="text-xs text-gray-500 group-hover:text-red-600">Status tidak berjalan</p>
                        </div>
                    </div>
                    <svg class="w-5 h-5 text-gray-300 group-hover:text-red-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </div>
            </button>
...
<style>
    ...
    #statusModal:not(.hidden) .modal-content {
...
<script>
    ...
    closeModalX.addEventListener('click', closeModalFunc);
